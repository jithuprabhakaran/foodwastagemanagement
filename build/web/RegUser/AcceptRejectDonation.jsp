...
<%
    int regid=Integer.parseInt(""+session.getAttribute("userid"));
    String sel="",str="",type="";
    ResultSet rs=null;
    ...
    <body>
        <form name="frmAcceptRejectDonation" action="AcceptRejectDonation.jsp" method="POST">
            ...
            <table class="CSSTableGenerator2">
                    ...
                    <%
                        sel="select * from tbl_donation,tbl_guestuser where reguser_id="+regid+" and tbl_donation.guest_id=tbl_guestuser.guest_id and don_status='P'";
                        rs=obj.select(sel);
                        while(rs.next())
                        {
                ...
                <br>
                 ...
                 <table class="CSSTableGenerator2">
                    ...
                    <%
                        sel="select * from tbl_donation,tbl_guestuser where reguser_id="+regid+" and tbl_donation.guest_id=tbl_guestuser.guest_id and don_status='A'";
                        rs=obj.select(sel);
                        while(rs.next())
                        {
                            if(rs.getString("don_type").equals("A"))
